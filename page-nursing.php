...
<main>
    <p class="pkz">トップ　＞　運動療育について</p>

    <div class="nur_ttl">
        <h2>「ギフテッドの公園での遊び方は、<br>
            <span class="nurttl_c_p">自由に遊んで</span>もらいながら、<br>
            <span class="nurttl_c_b">楽しく療育</span>のサポートを受けられる。」
        </h2>
        <p>とくしまGo！Go!パークなびでは、公園の遊具に注目し、療育の専門として活動する
            新田昌広先生監修のもと公園で経験できる遊びや遊具について独自調査をしました。
            公園での遊びの参考にしてみてくださいね。
        </p>
    </div>
        ...
        <div class="nur_list">
            ...
            <div class="row_flex">
                ...
                <div class="column_flex">
                    <p class="txt">
                        放課後等デイサービス　ギフテッド・トレラグループ代表の新田です。私は元々、公立の小学校で約３年間、クラス担任や理科専科教員をしていました。その後は支援学校の非常勤講師や放課後等デイサービスで勤務をし、2013年の暮れに板野町にて当時珍しかった<span class="txt_mark">個別で学習支援や問題行動の改善を図る</span>ギフテッドをオープンしました。現在はギフテッド板野、南二軒屋、藍住。板野町内に運動指導を中心としたトレラという4つの事業所を経営しています。
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row_flex">
                ...
                <div class="column_flex">
                    <p class="txt">TV番組やゲームは子どもの興味を引くよう研究され、作られていますので、どうしても子どもたちがそっちにいくのは、当たり前だろうと思います。
                        いくらゲームやTVが面白くても、子どもは自然の中につれていくと、夢中になって遊んでくれるはずです。<span class="txt_mark">大切なのは、親御さんが自然の中に子どもをつれていくこと</span>だと思います。<br>
